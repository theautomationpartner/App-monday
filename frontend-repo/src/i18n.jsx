...
export const translations = {
  es: {
    ...
    "cert.s3Title": "Configuralo en AFIP",
    "cert.s3Desc": "Se hace en el portal de AFIP con la clave fiscal de tu empresa. Son 3 partes — seguilas en orden.",
    ...
    "map.exchangeHint":
      "Celda vacía → la app pide cotización a AFIP y la escribe acá como registro. Con valor → se respeta como override.<br/>En una <b>Nota de Crédito o Débito</b>, vacío hereda el tipo de cambio de la factura que ajusta.",
    ...
    // ── Validaciones de Datos Fiscales (validateFiscal) ──
    "val.razonSocial.msg": "Falta la razón social",
    "val.razonSocial.hint": "Cargá la razón social registrada en AFIP (la que figura en tu constancia).",
    "val.fantasia.msg": "Falta el nombre de fantasía",
    "val.fantasia.hint": "Es el nombre comercial que aparece en negrita arriba del PDF. Si no tenés, poné lo mismo que la razón social.",
    "val.cuit.msg": "CUIT inválido",
    "val.cuit.hint": "El CUIT debe tener 11 dígitos. Sin guiones ni puntos. Ejemplo: 20123456789.",
    "val.puntoVenta.msg": "Falta el punto de venta",
    "val.puntoVenta.hint": "Ingresá el número de punto de venta habilitado en AFIP/ARCA. Es un número (ej: 1, 2, 5).",
    "val.fechaInicio.msg": "Falta la fecha de inicio de actividades",
    "val.fechaInicio.hint": "La fecha que figura en tu constancia de inscripción de AFIP.",
    "val.domicilio.msg": "Falta el domicilio comercial",
    "val.domicilio.hint": "El domicilio fiscal registrado en AFIP. Aparece en el PDF de la factura.",
    "val.email.msg": "Email con formato inválido",
    "val.email.hint": "Revisá que tenga el formato correcto, ej: ventas@empresa.com.ar",
    // ── Errores de API (friendlyApiError) ──
    "val.MISSING_TRADE_NAME.msg": "Falta el nombre de fantasía",
    "val.MISSING_TRADE_NAME.hint": "Cargálo arriba del CUIT. Puede ser igual a la razón social si no tenés uno comercial.",
    "val.MISSING_FISCAL_DATA.msg": "Faltan datos fiscales",
    "val.MISSING_FISCAL_DATA.hint": "Cargá razón social, CUIT y punto de venta antes de continuar.",
    "val.INVALID_EMAIL.msg": "Email con formato inválido",
    "val.INVALID_EMAIL.hint": "Tiene que tener un @ y un dominio válido (ej: ventas@empresa.com).",
    "val.INVALID_WEBSITE.msg": "Sitio web con formato inválido",
    "val.INVALID_WEBSITE.hint": "Empezá con http:// o https:// (ej: https://empresa.com).",
    "val.INVALID_LOGO_MIME.msg": "Formato de logo no soportado",
    "val.INVALID_LOGO_MIME.hint": "Usá PNG, JPG, SVG o WebP. Otros formatos no se aceptan.",
    "val.LOGO_TOO_LARGE.msg": "El logo es muy grande",
    "val.LOGO_TOO_LARGE.hint": "Reducilo a menos de 500 KB (podés comprimirlo en tinypng.com).",
    "val.KEY_CRT_MISMATCH.msg": "El .crt y el .key no son pareja",
    "val.KEY_CRT_MISMATCH.hint": "Bajaste el cert correspondiente a otra solicitud. Volvé a generar el CSR y descargá el .crt nuevo de ARCA.",
    "val.CRT_EXPIRED.msg": "El certificado venció",
    "val.CRT_EXPIRED.hint": "Generá uno nuevo en ARCA con el mismo alias y volvé a subirlo.",
    "val.NO_PENDING_CSR.msg": "No hay una solicitud pendiente",
    "val.NO_PENDING_CSR.hint": "Generá primero el CSR desde el paso 1 antes de subir el .crt.",
    "val.401.msg": "Tu sesión expiró",
    "val.401.hint": "Cerrá la pestaña de monday y volvé a abrir la app.",
    "val.403.msg": "No tenés permisos",
    "val.403.hint": "Pedíle al admin de monday que te de permisos sobre este tablero.",
    "val.404.msg": "No se encontró la empresa",
    "val.404.hint": "Cargá primero los Datos Fiscales antes de hacer esta acción.",
    "val.413.msg": "El archivo es muy grande",
    "val.413.hint": "Subí uno más liviano.",
    ...
    "cert.copy": "Copiar",
    "cert.s3.adheredTitle": 'Ya tengo habilitado el servicio <strong>"Administración de Certificados Digitales"</strong> en AFIP',
    "cert.s3.firstTime": "<strong>① Habilitá el servicio de certificados</strong> (solo la primera vez):",
    "cert.s3.adhereLi1": 'En AFIP, buscá y entrá a <strong>"Administrador de Relaciones de Clave Fiscal"</strong>.',
    "cert.s3.adhereLi2": 'Tocá el botón <strong>"Adherir Servicio"</strong>.',
    "cert.s3.adhereLi3": 'En la lista de organismos: <strong>ARCA</strong> → <strong>Servicios Interactivos</strong> → <strong>"Administración de Certificados Digitales"</strong>.',
    "cert.s3.adhereLi4": 'Tocá <strong>Confirmar</strong>. <em>Si te dice "la autorización ya existe", es que ya lo tenías habilitado: pasá directo al paso ②.</em>',
    "cert.s3.b2Title": "② Creá el certificado",
    "cert.s3.li1": 'En AFIP, entrá a <strong>"Administración de Certificados Digitales"</strong>.',
    "cert.s3.li2": 'Tocá <strong>"Agregar alias"</strong>.',
    "cert.s3.li3Lead": 'En el campo <strong>"Alias"</strong> pegá este valor:',
    "cert.s3.li4": 'En <strong>"Elegir archivo"</strong> subí el <code>.csr</code> que descargaste (paso 2) y tocá <strong>"Agregar alias"</strong>.',
    "cert.s3.li5": 'Tocá <strong>"Ver"</strong> en el alias nuevo y descargá el <code>.crt</code> (ícono <strong>Descargar</strong>). Ese archivo lo subís en el <strong>paso 4</strong> de esta app.',
    "cert.s3.b3Title": "③ Autorizá el certificado para facturar",
    "cert.s3.b3Warn": '<strong>¡No te saltees este paso!</strong> Sin él, el certificado existe pero <strong>no puede emitir</strong>: AFIP rechaza con "Computador no autorizado a acceder al servicio".',
    "cert.s3.b3Li1": 'Volvé a <strong>"Administrador de Relaciones de Clave Fiscal"</strong> y tocá <strong>"Nueva Relación"</strong>.',
    "cert.s3.b3Li2": 'En <strong>"Servicio"</strong> tocá <strong>"Buscar"</strong> → <strong>ARCA</strong> → <strong>WebServices</strong> → <strong>"Facturación Electrónica"</strong>.',
    "cert.s3.b3Li3": 'En <strong>"Representante"</strong> tocá <strong>"Buscar"</strong> → en <strong>"Computador Fiscal"</strong> elegí <strong>tu certificado</strong> (el alias de arriba) → <strong>"Confirmar"</strong>.',
    "cert.s3.b3Note": "Esperá 5-10 minutos a que AFIP lo active y ya podés emitir. ✅",
    ...
    // ── Paso 2 título/desc + diagnostic boxes del Mapeo ──
    "cert.s2Title": "Descargá tu solicitud",
    "cert.s2Desc": "Este archivo <code>.csr</code> lo vas a subir al portal de ARCA en el siguiente paso.",
    "map.diag.noSubitemsTitle": "Columnas de subitems no detectadas.",
    "map.diag.noSubitemsBody": "Asegurate de que el tablero tenga al menos un subitem creado y recargá la vista.",
    "map.diag.missingTitle": "Faltan seleccionar:",
    "map.diag.missingSuffix": "— Los campos marcados en rojo deben asignarse antes de guardar.",
    // ── Badge de vencimiento del certificado (texto computado) ──
    "cert.badge.expired": "Vencido",
    "cert.badge.expiresInPre": "Vence en ",
    "cert.badge.daysSuffix": " días",
    "cert.badge.daysRemaining": " días restantes",
    // ── Splash / marca / header / mockup / ayudas restantes ──
    "splash.title": "Cargando tu app…",
    "splash.sub": "Conectando con monday y trayendo tu configuración.",
    "brand.title": "Facturación AFIP",
    "header.kicker": "monday App · Facturación Electrónica AFIP",
    "header.allSet": "Todo listo. Tu app está facturando.",
    "header.youStillNeedPre": "Te falta ",
    "header.youStillNeedSuf": " para empezar a facturar",
    "header.almostReady": "Casi listo",
    "cert.manualEntryDesc": "Si ya tenés tu <code>.crt</code> y <code>.key</code> generados por fuera.",
    "map.invoicePreviewLabel": "Vista previa en la factura:",
    "map.yourLogoHere": "Tu logo<br/>acá",
    "map.modelInvoiceHeader": "FACTURA",
    "map.previewSampleCompany": "Tu Empresa S.A.",
    "map.previewSampleAddress": "Av. Ejemplo 1234, CABA",
    "map.mockRazonSocial": "Razón Social:",
    "map.mockDomicilio": "Domicilio:",
    "map.mockCuit": "CUIT:",
    "err.csrEmpty": "El servidor no devolvió el CSR",
    "err.csrEmptyRedownload": "No se recibió el CSR del servidor",
    "err.noColumns": "La query respondió sin columnas. Verificá que el board esté accesible.",
    "map.currencyHelp": "El item escribe <code>Pesos</code> o <code>Dólares</code> (mayúsc/minúsc/tilde indistinto). Vacío → Pesos.<br/>En una <b>Nota de Crédito o Débito</b>, vacío significa <i>la misma moneda que la factura</i>. Con valor, la nota va en esa moneda — así se documenta una diferencia de tipo de cambio.",
    "map.voucherTypeHelp": "El dropdown del item debe tener las opciones: <b>Factura</b>, <b>Nota de Crédito</b>, <b>Nota de Débito</b>.",
    "map.renameExample": 'Ej: <em>"Cliente Juan"</em> pasa a <em>"Factura B N° 0002-00000019"</em> tras emitir.',
    "common.companyLogoAlt": "Logo de la empresa",
    "map.statusExample": "Ej: <em>Procesando</em> → <em>Comprobante Creado</em>, o <em>Error</em> si falla.",
    "common.processingSecurely": "Procesando datos de forma segura...",
    "readonly.title": "Acceso de solo lectura",
    "readonly.sub": "Como viewer en monday no tenés permisos para usar ARCA Facturación. Pedile a un administrador del workspace que te asigne permisos de miembro para configurar y emitir facturas.",
    "map.diag.colsNotLoaded": "Columnas no cargadas.",
    "map.diag.diagInfo": "Información de diagnóstico:",
    "map.diag.notAvailable": "no disponible",
    "map.diag.itemCols": "Columnas ítem:",
    // ── Header subtitle / botón how-to / usage banner / badge / status help ──
    "header.sub": "Configurá tu app una vez. Después cada cambio de estado en el tablero dispara una factura AFIP automática.",
    "header.howToUse": "Cómo usar la app",
    "usage.unlimited": "Comprobantes ilimitados este mes",
    "usage.vouchersThisMonth": "comprobantes este mes",
    "usage.cancelled": "Suscripción cancelada",
    "usage.trialExpired": "Trial finalizado",
    "usage.renewPlan": "Renová tu plan",
    "usage.upgradePlan": "Upgradeá tu plan",
    "map.fieldsMapped": "campos mapeados",
    "map.statusColHelpPre": "La app va a cambiar esta columna a ",
    "map.statusColHelpMid": " al disparar la emisión, y a ",
    "map.statusColHelpSuf": " cuando AFIP devuelva el CAE.",
    // ── Feedback del logo (Datos Fiscales) ──
    "logo.fb.neutral": "Subí tu logo para verlo en la vista previa.",
    "logo.fb.smallPre": "⚠ La imagen es chica (",
    "logo.fb.smallSuf": " px). Puede verse borrosa al imprimir. Recomendamos al menos 300×300 px.",
    "logo.fb.tooWide": "ℹ Imagen muy alargada — el cuadro de la factura es casi cuadrado, así que puede quedar reducida.",
    "logo.fb.okPre": "✓ Se va a ver bien en la factura (",
    "logo.fb.okSuf": " px).",
    // ── Card "solicitud pendiente" (recovery de CSR) ──
    "cert.pendingBody1": "Generaste una solicitud",
    "cert.pendingBodyOn": " el ",
    "cert.pendingBody2": ". Falta subir el archivo ",
    "cert.pendingBody3": " que te da ARCA para terminar.",
    // ── Labels de blockers del toast "no se puede guardar" + notice auto-mapeo ──
    "map.f.caeComprobante": "CAE del Comprobante",
    "map.f.razonSocialReceptor": "Razón Social del Receptor",
    "map.f.condicionIvaReceptor": "Condición IVA del Receptor",
    "map.f.tipoComprobante": "Tipo de Comprobante",
    "map.f.facturaReferencia": "CAE de la factura a anular",
    "map.f.nroFactura": "N° Factura (Pto-Nro)",
    "map.f.nroComprobante": "N° Comprobante",
    "map.f.letraComprobante": "Letra del Comprobante",
    "blocker.map": "Mapear",
    "blocker.pdfColumn": "Seleccionar la columna donde subir el PDF (en \"Columna Comprobante PDF\")",
    "blocker.statusColumn": "Seleccionar la columna de estado (porque activaste \"Cambiar el estado del item\")",
    "notice.autoMapConfigured": "Mapeo automático configurado para la plantilla de facturación",
    // ── Franja de debug (solo cuentas whitelisteadas) ──
    "debug.backendOk": "Backend conectado correctamente",
    "debug.backendChecking": "Verificando conexión backend...",
    "debug.backendError": "Backend sin conexión",
    "debug.cantConnect": "No se pudo conectar al backend",
  },
  en: {
    // ── Sidebar / navigation ──
    ...
    "cert.s3Title": "Set it up in AFIP",
    "cert.s3Desc": "Done in the AFIP portal with your company's tax code. There are 3 parts — follow them in order.",
    ...
    "map.exchangeHint":
      "Empty cell → the app requests the rate from AFIP and writes it here as a record. With a value → it's respected as an override.<br/>On a <b>Credit or Debit Note</b>, empty inherits the exchange rate of the invoice being adjusted.",
    ...
    // ── Tax data validation (validateFiscal) ──
    "val.razonSocial.msg": "Missing legal name",
    "val.razonSocial.hint": "Enter the legal name registered with AFIP (the one on your registration certificate).",
    "val.fantasia.msg": "Missing trade name",
    "val.fantasia.hint": "It's the commercial name shown in bold at the top of the PDF. If you don't have one, use the same as the legal name.",
    "val.cuit.msg": "Invalid CUIT",
    "val.cuit.hint": "The CUIT must be 11 digits. No dashes or dots. Example: 20123456789.",
    "val.puntoVenta.msg": "Missing point of sale",
    "val.puntoVenta.hint": "Enter the point-of-sale number enabled in AFIP/ARCA. It's a number (e.g. 1, 2, 5).",
    "val.fechaInicio.msg": "Missing activity start date",
    "val.fechaInicio.hint": "The date shown on your AFIP registration certificate.",
    "val.domicilio.msg": "Missing business address",
    "val.domicilio.hint": "The tax address registered with AFIP. It appears on the invoice PDF.",
    "val.email.msg": "Invalid email format",
    "val.email.hint": "Check that it has the correct format, e.g. sales@company.com",
    // ── API errors (friendlyApiError) ──
    "val.MISSING_TRADE_NAME.msg": "Missing trade name",
    "val.MISSING_TRADE_NAME.hint": "Enter it above the CUIT. It can be the same as the legal name if you don't have a commercial one.",
    "val.MISSING_FISCAL_DATA.msg": "Missing tax data",
    "val.MISSING_FISCAL_DATA.hint": "Enter legal name, CUIT and point of sale before continuing.",
    "val.INVALID_EMAIL.msg": "Invalid email format",
    "val.INVALID_EMAIL.hint": "It must have an @ and a valid domain (e.g. sales@company.com).",
    "val.INVALID_WEBSITE.msg": "Invalid website format",
    "val.INVALID_WEBSITE.hint": "Start with http:// or https:// (e.g. https://company.com).",
    "val.INVALID_LOGO_MIME.msg": "Unsupported logo format",
    "val.INVALID_LOGO_MIME.hint": "Use PNG, JPG, SVG or WebP. Other formats are not accepted.",
    "val.LOGO_TOO_LARGE.msg": "The logo is too large",
    "val.LOGO_TOO_LARGE.hint": "Reduce it to under 500 KB (you can compress it at tinypng.com).",
    "val.KEY_CRT_MISMATCH.msg": "The .crt and .key don't match",
    "val.KEY_CRT_MISMATCH.hint": "You downloaded the cert for a different request. Generate the CSR again and download the new .crt from ARCA.",
    "val.CRT_EXPIRED.msg": "The certificate expired",
    "val.CRT_EXPIRED.hint": "Generate a new one in ARCA with the same alias and upload it again.",
    "val.NO_PENDING_CSR.msg": "There's no pending request",
    "val.NO_PENDING_CSR.hint": "Generate the CSR first from step 1 before uploading the .crt.",
    "val.401.msg": "Your session expired",
    "val.401.hint": "Close the monday tab and reopen the app.",
    "val.403.msg": "You don't have permission",
    "val.403.hint": "Ask your monday admin to give you permissions on this board.",
    "val.404.msg": "Company not found",
    "val.404.hint": "Enter your Tax Details first before doing this action.",
    "val.413.msg": "The file is too large",
    "val.413.hint": "Upload a lighter one.",
    ...
    "cert.copy": "Copy",
    "cert.s3.adheredTitle": 'I already have the <strong>"Administración de Certificados Digitales"</strong> service enabled in AFIP',
    "cert.s3.firstTime": "<strong>① Enable the certificates service</strong> (first time only):",
    "cert.s3.adhereLi1": 'In AFIP, search for and open <strong>"Administrador de Relaciones de Clave Fiscal"</strong>.',
    "cert.s3.adhereLi2": 'Click the <strong>"Adherir Servicio"</strong> button.',
    "cert.s3.adhereLi3": 'In the list of agencies: <strong>ARCA</strong> → <strong>Servicios Interactivos</strong> → <strong>"Administración de Certificados Digitales"</strong>.',
    "cert.s3.adhereLi4": 'Click <strong>Confirmar</strong>. <em>If it says "la autorización ya existe" (it already exists), you already had it enabled — skip to step ②.</em>',
    "cert.s3.b2Title": "② Create the certificate",
    "cert.s3.li1": 'In AFIP, open <strong>"Administración de Certificados Digitales"</strong>.',
    "cert.s3.li2": 'Click <strong>"Agregar alias"</strong>.',
    "cert.s3.li3Lead": 'In the <strong>"Alias"</strong> field, paste this value:',
    "cert.s3.li4": 'In <strong>"Elegir archivo"</strong> (Choose file) upload the <code>.csr</code> you downloaded (step 2) and click <strong>"Agregar alias"</strong>.',
    "cert.s3.li5": 'Click <strong>"Ver"</strong> on the new alias and download the <code>.crt</code> (<strong>Descargar</strong> icon). Upload that file in <strong>step 4</strong> of this app.',
    "cert.s3.b3Title": "③ Authorize the certificate to invoice",
    "cert.s3.b3Warn": '<strong>Do not skip this step!</strong> Without it, the certificate exists but <strong>cannot issue invoices</strong>: AFIP rejects with "Computador no autorizado a acceder al servicio" (computer not authorized).',
    "cert.s3.b3Li1": 'Go back to <strong>"Administrador de Relaciones de Clave Fiscal"</strong> and click <strong>"Nueva Relación"</strong>.',
    "cert.s3.b3Li2": 'In <strong>"Servicio"</strong> click <strong>"Buscar"</strong> → <strong>ARCA</strong> → <strong>WebServices</strong> → <strong>"Facturación Electrónica"</strong>.',
    "cert.s3.b3Li3": 'In <strong>"Representante"</strong> click <strong>"Buscar"</strong> → under <strong>"Computador Fiscal"</strong> choose <strong>your certificate</strong> (the alias above) → <strong>"Confirmar"</strong>.',
    "cert.s3.b3Note": "Wait 5-10 minutes for AFIP to activate it and you're ready to invoice. ✅",
    ...
    // ── Step 2 title/desc + Mapping diagnostic boxes ──
    "cert.s2Title": "Download your request",
    "cert.s2Desc": "You'll upload this <code>.csr</code> file to the ARCA portal in the next step.",
    "map.diag.noSubitemsTitle": "Subitem columns not detected.",
    "map.diag.noSubitemsBody": "Make sure the board has at least one subitem created, and reload the view.",
    "map.diag.missingTitle": "Still to select:",
    "map.diag.missingSuffix": "— The fields marked in red must be assigned before saving.",
    // ── Certificate expiration badge (computed text) ──
    "cert.badge.expired": "Expired",
    "cert.badge.expiresInPre": "Expires in ",
    "cert.badge.daysSuffix": " days",
    "cert.badge.daysRemaining": " days remaining",
    // ── Splash / brand / header / mockup / remaining help ──
    "splash.title": "Loading your app…",
    "splash.sub": "Connecting to monday and loading your configuration.",
    "brand.title": "AFIP Invoicing",
    "header.kicker": "monday App · AFIP Electronic Invoicing",
    "header.allSet": "All set. Your app is invoicing.",
    "header.youStillNeedPre": "You still need ",
    "header.youStillNeedSuf": " to start invoicing",
    "header.almostReady": "Almost ready",
    "cert.manualEntryDesc": "If you already have your <code>.crt</code> and <code>.key</code> generated elsewhere.",
    "map.invoicePreviewLabel": "Preview on the invoice:",
    "map.yourLogoHere": "Your logo<br/>here",
    "map.modelInvoiceHeader": "INVOICE",
    "map.previewSampleCompany": "Your Company Inc.",
    "map.previewSampleAddress": "123 Main St, City",
    "map.mockRazonSocial": "Legal Name:",
    "map.mockDomicilio": "Address:",
    "map.mockCuit": "CUIT:",
    "err.csrEmpty": "The server did not return the CSR",
    "err.csrEmptyRedownload": "No CSR was received from the server",
    "err.noColumns": "The query returned no columns. Make sure the board is accessible.",
    "map.currencyHelp": "The item writes <code>Pesos</code> or <code>Dollars</code> (case/accent-insensitive). Empty → Pesos.<br/>On a <b>Credit or Debit Note</b>, empty means <i>the same currency as the invoice</i>. With a value, the note goes in that currency — that is how an exchange-rate difference is documented.",
    "map.voucherTypeHelp": "The item's dropdown must have the options: <b>Invoice</b>, <b>Credit Note</b>, <b>Debit Note</b>.",
    "map.renameExample": 'E.g. <em>"Client John"</em> becomes <em>"Invoice B No. 0002-00000019"</em> after issuing.',
    "common.companyLogoAlt": "Company logo",
    "map.statusExample": "E.g. <em>Creating Voucher</em> → <em>Voucher Created</em>, or <em>Error</em> if it fails.",
    "common.processingSecurely": "Processing data securely...",
    "readonly.title": "Read-only access",
    "readonly.sub": "As a viewer in monday you don't have permission to use AFIP Invoicing. Ask a workspace administrator to assign you member permissions to set up and issue invoices.",
    "map.diag.colsNotLoaded": "Columns not loaded.",
    "map.diag.diagInfo": "Diagnostic info:",
    "map.diag.notAvailable": "not available",
    "map.diag.itemCols": "Item columns:",
    // ── Header subtitle / how-to button / usage banner / badge / status help ──
    "header.sub": "Set up your app once. After that, each status change on the board triggers an automatic AFIP invoice.",
    "header.howToUse": "How to use the app",
    "usage.unlimited": "Unlimited vouchers this month",
    "usage.vouchersThisMonth": "vouchers this month",
    "usage.cancelled": "Subscription cancelled",
    "usage.trialExpired": "Trial ended",
    "usage.renewPlan": "Renew your plan",
    "usage.upgradePlan": "Upgrade your plan",
    "map.fieldsMapped": "fields mapped",
    "map.statusColHelpPre": "The app will change this column to ",
    "map.statusColHelpMid": " when issuing, and to ",
    "map.statusColHelpSuf": " when AFIP returns the CAE.",
    // ── Logo feedback (Tax Details) ──
    "logo.fb.neutral": "Upload your logo to see it in the preview.",
    "logo.fb.smallPre": "⚠ The image is small (",
    "logo.fb.smallSuf": " px). It may look blurry when printed. We recommend at least 300×300 px.",
    "logo.fb.tooWide": "ℹ Very wide image — the invoice's logo box is almost square, so it may end up shrunk.",
    "logo.fb.okPre": "✓ It will look good on the invoice (",
    "logo.fb.okSuf": " px).",
    // ── "Pending request" card (CSR recovery) ──
    "cert.pendingBody1": "You generated a request",
    "cert.pendingBodyOn": " on ",
    "cert.pendingBody2": ". You still need to upload the ",
    "cert.pendingBody3": " file that ARCA gives you to finish.",
    // ── Blocker labels for the "can't save" toast + auto-map notice ──
    "map.f.caeComprobante": "Voucher CAE",
    "map.f.razonSocialReceptor": "Recipient Legal Name",
    "map.f.condicionIvaReceptor": "Recipient VAT Condition",
    "map.f.tipoComprobante": "Voucher Type",
    "map.f.facturaReferencia": "CAE of the invoice to cancel",
    "map.f.nroFactura": "Invoice No. (POS-No.)",
    "map.f.nroComprobante": "Voucher No.",
    "map.f.letraComprobante": "Voucher Letter",
    "blocker.map": "Map",
    "blocker.pdfColumn": "Select the column to upload the PDF to (in \"Voucher PDF Column\")",
    "blocker.statusColumn": "Select the status column (because you enabled \"Change the item status\")",
    "notice.autoMapConfigured": "Automatic mapping configured for the invoicing template",
    // ── Debug strip (whitelisted accounts only) ──
    "debug.backendOk": "Backend connected successfully",
    "debug.backendChecking": "Checking backend connection...",
    "debug.backendError": "Backend not connected",
    "debug.cantConnect": "Couldn't connect to the backend",
  },
};
