...
export const translations = {
  es: {
    ...
    "map.currencyHelp": "El item escribe <code>Pesos</code> o <code>Dólares</code> (mayúsc/minúsc/tilde indistinto). Vacío → Pesos.",
  ...
  en: {
    ...
    "map.currencyHelp": "The item writes <code>Pesos</code> or <code>Dollars</code> (case/accent-insensitive). Empty → Pesos.",
