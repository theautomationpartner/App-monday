...
export const translations = {
  ...
  en: {
    ...
    "map.currencyHelp": "The item writes <code>Pesos</code> or <code>Dólares</code> (case/accent-insensitive). Empty → Pesos.",
    "map.voucherTypeHelp": "The item's dropdown must have the options: <b>Factura</b>, <b>Nota de Crédito</b>, <b>Nota de Débito</b>.",
    "map.renameExample": 'E.g. <em>"Cliente Juan"</em> becomes <em>"Factura B N° 0002-00000019"</em> after issuing.',
    "common.companyLogoAlt": "Company logo",
    "map.statusExample": "E.g. <em>Procesando</em> → <em>Comprobante Creado</em>, or <em>Error</em> if it fails.",
    "common.processingSecurely": "Processing data securely...",
    "readonly.title": "Read-only access",
    "readonly.sub": "As a viewer in monday you don't have permission to use ARCA Facturación. Ask a workspace administrator to assign you member permissions to set up and issue invoices.",
